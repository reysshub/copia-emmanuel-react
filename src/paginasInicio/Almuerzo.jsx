  ...
  return (
    <>
      ...
      <TarjetaBlanca>
        ...
        <Espacio />
        <Espacio />
        <TituloMedio>Simpatía, Satisfacción, Salud </TituloMedio>
        <Espacio />
      </TarjetaBlanca>
      ...
      <TarjetaBlanca>
        ...
        <LetraAlmuerzo>
          ...
          3. Consulte con la directora antes de cocinar, para mejor balance de
          los alimentos. <br />
          4. Los hermanos proveen comida y recursos. <br />
          5. Hermanas con amor preparan los alimentos. <br />
          6. Aceptamos donación de: platos, vasos, cubiertos desechables,
          servilletas, etc. <br />
      ...
      <TarjetaBlanca>
        ...
        <LetraAlmuerzo>
          ...
          <Espacio />
          2. Hagamos planes para hacer la preparación de los alimentos el
          viernes antes de la puesta del sol y no el sábado. Queremos adorar al
          Creador del sábado.
          <Espacio />
          3. Mantenga buena comunicación con la directora. No quisiéramos que la
          comida se desperdicie. Tampoco quisiéramos que alguien se quede sin
          comer o con hambre.
          <Espacio />
          4. Es preferible que usted traiga la comida en una bandeja desechable
          y lista para servir.
          <Espacio />
          Eso significa que la comida venga ya caliente (no fría del
          refrigerador).
          <Espacio />
          Si todos lo hacemos de esa manera, cooperamos para que el equipo de la
          cocina no se pierda el culto.
          <Espacio />
          También ahorramos tiempo a la hora de servir.
          <Espacio />
          Si usted calienta la comida, la pone en la bandeja desechable, la
          envuelve en una tela aparente (toalla o algo parecido), y luego la
          mete dentro de una bolsa plástica y la cierra: la comida mentiene el
          calor hasta la hora de ser servida.
          <Espacio />
          5. No olviden que esto lo hacemos para Dios y para la humanidad, por
