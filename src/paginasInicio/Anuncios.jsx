	...
	return (
		<>
			...
			<TarjetaBlanca>
				...
				<LetraGrande>El Hotel está Completo</LetraGrande>
				<LetraChica>
					Si aun estás interesado en asistir, comunícate con Dorys Ojeda para
					ver si existen opciones
				</LetraChica>
				<ImagenMedia>
			...
			<TarjetaBlanca>
				...
				<LetraGrande>
					Conectar a nuestros profesionales con los miembros. <br />
					Profesional de Emmanuel, envíame tu información, si así lo deseas.{' '}
					<br />
					Lee bien las instrucciones. El Pastor.
					<br />
				</LetraGrande>
				<Espacio />
			...
			<TarjetaBlanca>
				...
				<LetraGrande>
					...
					Será en Camp Kulaqua <br />
					Octubre 12 - 16 / 2022 <br />
					Regístrate Ya
				</LetraGrande>
				<FotoLogo>
