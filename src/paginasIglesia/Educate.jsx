...
const Educate = () => {
  return (
    <>
      <TituloMedio>
        <ColorWhite>Miembros y Líderes</ColorWhite>
      </TituloMedio>
      <TituloChico>
      ...
      <TarjetaBlanca>
        ...
        <LetraGrande>Iglesia Adventista del Séptimo Día</LetraGrande>
        <Espacio />
        <BotonLargo>
      ...
      <TarjetaColor>
        <TituloBlanco>Sección Temas Actualidad Social</TituloBlanco>
      </TarjetaColor>

      <TarjetaBlanca>
        <TituloGrande>Conferencia Familia y más</TituloGrande>
      ...
      <TarjetaBlanca>
        ...
        <Espacio />
        <LetraGrande>
          Departamento Educación y Lectura <br />
