	...
	return (
		<>
			...
			<TarjetaBlanca>
				...
				<Espacio />
				<LetraTexto>
					<b>Sábados Temprano en el Templo</b>
					<Espacio />
					Hora - 9:15 am -- 9:40 am
					<Espacio />
					<b>Miércoles por Zoom</b>
					<Espacio />
			...
			<TarjetaBlanca>
				...
				<LetraTexto>
					...
					llama, se le abrirá". <br /> Mateo 7:7, 8
				</LetraTexto>
				<Espacio />
				<ImagenSombra>
			...
			<TarjetaBlanca>
				...
				<LetraAlmuerzo>
					...
					3. Gilberto González (Nuevo Hermano) <br />
					4. Sahely Alfonso (Recibiendo estudios) <br />
					5. Zurina Vázquez (Nieta de Irma Durán) <br />
					6. Meeyah Vázquez (Mía, Nieta de Irma Durán) <br />
					7. Gabriel Jiménez (Esposo de Irma Durán) <br />
					8. Gisela Portal (Amiga de Elsy) <br />
					9. Pedro Buenaño (Esposo de Ceferina) <br />
			...
			<TarjetaBlanca>
				...
				<BordeCentro>
					<LetraTexto>
						...
						salud, así como tu alma está en prosperidad". <br />3 Juan 1:2
					</LetraTexto>
				</BordeCentro>
			</TarjetaBlanca>
