...
const IglesiaEs = () => {
  return (
    <>
      <TituloMedio>
        <ColorWhite>Reflexionando</ColorWhite>
      </TituloMedio>
      <TituloChico>
        <ColorWhite>Sobre la Iglesia</ColorWhite>
      </TituloChico>
      ...
      <TarjetaBlanca>
        ...
        <LetraGrande>
          ...
          Allí estaba su iglesia.
        </LetraGrande>
        <LetraAlmuerzo>
          La iglesia es más que un edificio, más que un nombre, y mucho más que
          una programación.
          <Espacio />
          De acuerdo a la Biblia, la iglesia es el cuerpo de Cristo. La suma de
          todos los que han depositado su fe en el Señor Jesucristo, le aman, le
          sirven, le escuchan, le siguen, le esperan.
          <Espacio />
          Eso incluye también a muchos que simplemente están intentando
          conocerle, y a otros que ni siguiera están en su redil todavía.
          <Espacio />
          La iglesia no está definida por una cultura, una época, una modalidad
          social, un gusto personal o apreciación individual.
          <Espacio />
          La iglesia no es un conjunto de reglas. No es una estructura o formato
          rígido, que se mantiene congelado a través del tiempo, cultura, lugar.
          Si miras el pasado, si estudias la historia, puedes verlo.
          <Espacio />
          La iglesia no es creada por la mente humana; no está limitada a ideas
          o conceptos de una persona, tampoco de un colectivo de personas.
          <Espacio />
          Dios ama a todos, e intenta alcanzarlos, sin depender de alguna
          condición relacionada con formas, estilos, liturgias. El puede recibir
          la adoración del más encumbrado de los mortales de la misma manera que
          del más pobre, ignorante miembro de la familia humana.
          <Espacio />
          ...
          <Espacio />
          Esa actitud de querer limitar la iglesia a conceptos humanos, a una
          visión humana, ha hecho daño a personas, desanimándolas y ha provocado
          que muchos rechacen la iglesia, la desprecien y se alejen de ella.
          <Espacio />
          ...
          tierra. "Sobre esta Roca edificaré mi Iglesia, y las puertas del hades
          ...
          como limitaciones. (Testimonios para los Ministros Capítulo 1)
          <Espacio />
          ...
          <Espacio />
          Muchos seres humanos, grandes y pequeños, han asumido la
          responsabilidad de moldearla, edificarla, protegerla, dirigirla,
          manipularla, pero eso ha sido y seguirá siendo un error, y hasta
          podría llegar a ser considerado como un crimen.
          <Espacio />
          La iglesia no existe sin Jesucrito. El es la condición indispensable.
          La iglesia tampoco existe sin personas. Está dirigida a salvar al
          pecador.
          <Espacio />
          Aunque las personas sirven a la iglesia, no son ellas las que la
          edifican, porque las personas somos imperfectas, pero el modelo de la
          ...
          <Espacio />
          Si te fijas en las 7 iglesias del Asia Menor, en Apocalipsis, te
          soprenderás de ver que todas tenían preciosas virtudes, pero también
          todas sin excepción tenían grandes defectos. Pero el Testigo Fiel y
          verdadero las anima, las cuida, las instruye con paciencia. Las ama.
          <Espacio />
          ...
          <Espacio />
          No es el ser humano el juez que determina cuando una iglesia hace las
